...
def visualize_timing_attack(timings, position):
    ...
    plt.title(f'timing analysis for position {position} (gatekeeper2)')
...
def main():
    ...
    print("vulnerability: byte-by-byte password comparison with longer password")
    print("attack vector: timing differences reveal correct characters")
    print("difference from gatekeeper1: different command ('b' vs 'a') and longer password\n")
